...
kernel = construct_RQ_kernel([1, 1/500, 3], bound=True)
...
def get_param_estimates(n_max, ns, true_params, initial_params, eps, num_restarts, num_replicates):
    ...
    np.save('./results/rational-quadratic-simulation.npy', param_estimates)
...
# Parameters
num_replicates = 100
true_params = [1, 1 / 300, 3]  # Example true parameters
