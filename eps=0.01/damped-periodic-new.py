...
def simulate_mles(n_max, ns, true_params, initial_params, eps, num_restarts=0):
    ...
    for n in ns:
        ...
        param_estimates = [gp_params['k1__k1__constant_value'],
                           gp_params['k1__k2__length_scale'],
...
kernel = construct_damped_periodic_kernel([1, 2, 3, 4])
...
def get_param_estimates(n_max, ns, true_params, initial_params, eps, num_restarts, num_replicates):
    ...
    np.save('./results/damped-periodic-simulation.npy', param_estimates)
...
# Parameters
num_replicates = 100
true_params = [1, 1/200, 1/100, 4]  # Example true parameters
